...
export function str(name: string, options: { default?: string; secret?: boolean } = {}): Spec<string>
{
    return {
        name,
...
export function oneOf<T extends string>(name: string, allowed: readonly T[], options: { default?: T } = {}): Spec<T>
{
    return {
        name,
        parse: (raw) =>
