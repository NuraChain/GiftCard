...
const CATALOG = {
    ...
    tiers: [
        { amount: 10, toman: 700_000, available: 4, title: 'کارت ده دلاری', blurb: 'رایج‌ترین انتخاب.', recommended: true }
    ]
};
...
describe('landing page', () =>
{
    ...
    {
        const { container } = render(<App url="/"/>);
        const button = container.querySelector<HTMLButtonElement>('[title^="تغییر پوسته"]') as HTMLButtonElement;
