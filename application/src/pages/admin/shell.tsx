                ...
                <div className="anim-settle mx-auto mt-section max-w-sm rounded-2xl border border-line bg-surface p-5 sm:p-6">
                    ...
                    <form className="mt-6" noValidate onSubmit={(event) => void signIn(event)}>
                        <div className="flex items-center justify-between gap-2">
                            <label className="text-small font-bold" htmlFor="admin-key-0">
                                کلید مدیریت
                            </label>
                        ...
                        <div
                            dir="ltr"
                            className={`mt-3 flex gap-2 ${shaking ? 'anim-shake' : ''}`}
                            ref={box}
                        >
                            {SEGMENTS.map((index) => (
                                <input
                        ...
                        <p className="mt-3 min-h-10 text-caption" aria-live="polite">
                            {signInError !== '' ? (
                                ...
                                <span className="text-muted">
                                    {16 - typed === 0
                                        ? 'کلید کامل است.'
                                        : `${16 - typed} نویسه مانده`}
                                </span>
                            ) : (
                                <span className="text-muted">
                                    کلید هنگام نخستین اجرای سرور، یک بار در ترمینال چاپ می‌شود.
                                </span>
                            )}
                        </p>
