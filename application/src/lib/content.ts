...
export const STEPS: Step[] = [
    {
        ...
        body: 'مبلغ را انتخاب می‌کنید و ایمیلتان را روی همان کارت وارد می‌کنید. حسابی نمی‌سازید و رمزی تعیین نمی‌کنید.'
    },
    {
        glyph: ShieldCheck,
    ...
    },
    {
        ...
        body: 'به محض تأیید پرداخت، کد روی صفحه نمایش داده می‌شود و همزمان به همان ایمیل فرستاده می‌شود.'
    }
];
...
export const ASSURANCES: Assurance[] = [
    { glyph: Zap, label: 'تحویل آنی', detail: 'روی صفحه و با ایمیل' },
...
export const FAQS: Faq[] = [
    {
        ...
        answer: 'بلافاصله پس از تأیید پرداخت. کد روی همان صفحه نمایش داده می‌شود و یک نسخه هم به ایمیلی که وارد کرده‌اید فرستاده می‌شود. تا کد را جایی ذخیره نکرده‌اید، صفحه را نبندید.'
    },
    {
        id: 'no-email',
        question: 'اگر پرداخت انجام شود ولی ایمیل نرسد؟',
        answer: 'کد شما از بین نمی‌رود. ایمیل فقط یک نسخهٔ کمکی است؛ کد اصلی همان است که روی صفحه می‌بینید. اول پوشهٔ اسپم را ببینید و اگر نبود، با شمارهٔ پیگیری با پشتیبانی تماس بگیرید تا همان کد را دوباره برایتان بفرستیم.'
    },
    {
        id: 'reference',
    ...
    },
    {
        ...
        answer: 'خیر. پرداخت روی درگاه زرین‌پال انجام می‌شود و شماره کارت بانکی شما وارد سرور ما نمی‌شود. آنچه نزد ما می‌ماند ایمیل و سابقه سفارش است تا بتوانیم پشتیبانی کنیم.'
    },
    {
        id: 'expiry',
